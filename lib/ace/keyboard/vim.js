    ...
    * in the right place.
    ...
    function showConfirm(cm, text) {
      if (cm.openNotification) {
        // ace_patch
        cm.openNotification(["span", {style: "color: red"}, text + ""],
    ...
    function makePrompt(prefix, desc) {
      ...
      var raw = [['span', {style: "font-family: monospace; white-space: pre"}, 
          (prefix || ""), ['input', {type: "text", autocorrect: "off",  autocapitalize: "none", autocomplete: "off"}]]];
      if (desc)
        raw.push(['span', {style: "color: #888"}, desc ]);
      return raw;
    }
